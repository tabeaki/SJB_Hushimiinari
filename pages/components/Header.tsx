     ...
     return <header>
            <nav className="max-w-full bg-black">
                ...
                <div className='justify-end flex'>
                    <div className="bg-[url('/whitepaperIcon.png')] px-4 pt-7 text-center bg-center bg-no-repeat bg-cover"><a className="px-2 py-4" href="/whitepaper"></a></div>
                    <div className="bg-[url('/how_to_buy.png')] px-4 pt-7 text-center bg-center bg-no-repeat bg-cover"><a className="px-2 py-4" href="/howtobuy"></a></div>
