     ...
     return <header>
            <nav className="max-w-full bg-black">
                ...
                <div className='justify-end flex'>
                    ...
                    <div className="bg-[url('/discode_icon.png')] px-2 pt-7 mr-4 text-center bg-center bg-no-repeat bg-cover"><a className="px-2 py-4" href="https://discord.gg/hA8FBMre"></a></div>
                </div>
                </div>
            </nav>
        </header>;
