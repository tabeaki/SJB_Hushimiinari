...
class HotReloader {
    ...
    async start(initial) {
        ...
        this.multiCompiler.hooks.done.tap("NextjsHotReloaderForServer", ()=>{
            ...
            const serverComponentChanges = serverOnlyChanges.concat(edgeServerOnlyChanges).filter((key)=>key.startsWith("app/")).concat(Array.from(changedCSSImportPages));
